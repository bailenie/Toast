...
1. **技术方案就绪**：`specs/features/{版本号}/{功能名称}_技术方案.md` 存在且包含完整的 AC 覆盖总表
2. **需求文档可查**：`specs/features/{版本号}/{功能名称}.md` 用于交叉验证 AC 覆盖
3. **项目认知建立**：读取 `specs/{版本号}/需求概述.md`是否存在，存在则按照该文档的内容进行操作(必须)
...
2. 填充内容，生成最终文档
3. 保存到 `specs/features/{版本号}/{功能名称}_任务规划.md`
